...
```
La serie è limitata a 43 iterazione solamente perchè il dollaro è stato considerato come la più piccola unità di moneta che può essere prestata. Una funzione continua (n.d.t. la serie geometrica che da luogo ad un ammontare di credito paria a` m * (1-r)/r`) porta ad un moltiplicatore monetario di 9 con un livello di riserva del 10%.

Le iterazioni sono riportate alla seguente tabella:
